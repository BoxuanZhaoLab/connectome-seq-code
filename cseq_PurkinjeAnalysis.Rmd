---
title: "Purkinje_analysis_091925"
output: html_document
date: "2025-09-19"
---

```{r}
Sys.setenv(RETICULATE_PYTHON = "/home/boxuan/anaconda3/envs/r44-scvi/bin/python")
reticulate::py_config()  # should show r44-scvi
...
load("/media/expansion/RNA_seq_processing/manuscript_update_082825/connectome_umi_version_cseq34_091725/correct.cseq.all.matched.BC.hamm5.RData") # changed here, 091925
...
pc9.scvi <- subset(pcm.scvi.joined, batch == "9")
...
pcm.scvi.imp$connectivity[Idents(pcm.scvi.imp) %in% c("1","2","3","4","6","7")] <- "Cseq-positive"


analyze_celltype_pc(pcm.scvi.cseq, pc9.scvi, "Purkinje")
analyze_celltype_pc(pcm.scvi.imp, pc9.scvi, "Purkinje", output_dir = "imp")
volcano_pc(pcm.scvi.imp, pc9.scvi, "Purkinje", output_dir = "volc")
```
